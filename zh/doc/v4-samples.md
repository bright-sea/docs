...
## Initial WebPivotTable with an csv file URL as data source 
...
## Initial WebPivotTable with an olap cube as data source 
...
## Initial WebPivotTable with a pre-saved wpt string and a CSV file as updated data source 
